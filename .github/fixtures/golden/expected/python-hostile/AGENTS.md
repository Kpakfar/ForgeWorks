...
<style-references>
Pattern-match every file you write or modify to a repo with `ticks` & "quotes" in its tagline. Reference material: https://example.com/hostile?a=1&b=2.
Explicitly avoid the shape of anything that switches on 'clever' escaping modes. Anti-pattern material: https://example.com/anti&pattern.
