...
<style-references>
Pattern-match every file you write or modify to the small-service shape of oklog/ulid's codebase. Reference material: https://github.com/oklog/ulid.
...
**How to use it**:
- Before writing the code, query Context7 for the relevant API of the **pinned version** in your manifest file (go.mod), not the latest available.
...
<!--
Project: Feedgate
Goal: An internal HTTP service that validates and normalizes partner RSS feeds before ingestion.
